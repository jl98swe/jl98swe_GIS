...
# Inställningar.
utmapp <- "~/GIS/GIS-lager/"                           # Välj mapp att spara filerna i.
spara_GIS <- TRUE                                      # Om GeoJSON-fil ska sparas.
lan <- c("Norrbottens län", "Västerbottens län",
         "Västernorrlands län", "Jämtlands län")       # Vektor med län som ska sparas.
